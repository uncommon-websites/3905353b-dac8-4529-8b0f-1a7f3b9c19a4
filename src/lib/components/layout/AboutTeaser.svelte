...
<script lang="ts">
	...
	name: "Steve Jobs",
	role: "Co-founder",
	image: "/generated/image-a-headshot-of-a-visionary-young-entrepre.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We started Apple to make technology feel more human—useful, simple, and a little magical."`}
			/>
